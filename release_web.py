...
p=subprocess.Popen("cocos compile -p web -m release", shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
out = p.communicate()[0]
...
print "exec: node ______mix.js"
task1_time=datetime.datetime.now()
p=subprocess.Popen("node ______mix.js", shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
out = p.communicate()[0]
print "done,"+(datetime.datetime.now()-task1_time).total_seconds().__str__()+"s"
